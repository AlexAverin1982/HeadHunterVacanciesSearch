...
class AreasReference:
    ...
    def __init__(self):     # type ignore
        ...
        def add_subareas(areas_list: list) -> None:
            for area_data in areas_list:
                ...
                if parent_id is None:
                    ...
                    if parent_name:
                        subareas_names = AreasReference.items_by_name.get(parent_name, {}).get('areas')
        ...
        self.subitems: list[str] = []     # список id регионов, у которых parent_id == id текущего региона
        # page=0
