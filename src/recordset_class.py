...
class RecordSet:
    ...
    def __init__(self) -> None:  # type: ignore
        self.properties: dict = {
            ...
            "salary": {"id": "", "value": "", "representation": "Минимальная зарплата"},
            # 'salary_max': {'id': '',
            #          'value': '',
            #          'representation': 'Максимальная зарплата'},
            "experience": {"id": "", "value": "", "representation": "Требуемый опыт"},
            "employer": {"id": "", "value": "", "representation": "Работодатель"},
        }

    def __str__(self) -> str:
        """
        Символьное представление набора свойст
        """
        result = ""
        ...
        for property_name in self.properties.keys():
            if self.properties[property_name].get("representation"):
                ...
                val = str(
                    self.properties[property_name].get("value", "значение не указано")
                )
                if val == "":
